...
class PortfolioItemResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Portfolio / Galereya';

    protected static string|\UnitEnum|null $navigationGroup = 'Kontent';

    protected static ?string $modelLabel = 'Portfolio ishi';

    protected static ?string $pluralModelLabel = 'Portfolio / Galereya';
